...
namespace AdService.Data.Migrations
{
    ...
    [Migration("20240224184136_RenameTableToAd")]
    partial class RenameTableToAd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdService.Models.Ad", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d18af6ef-2cdb-4c90-aed3-c9567e400b56"),
                            City = "Montpellier",
                            IdAnnonce = 1,
                            NumberOfRooms = 3,
                            Price = 300000m,
                            PublicationDate = new DateTime(2024, 2, 24, 19, 41, 36, 59, DateTimeKind.Local).AddTicks(5110),
                            Status = "Disponible",
